...
public class MealPlannerTest {
    ...
    void testAddMealPlan() {
        ...
        Meal<VegetarianMeal> vegMealWrapped = new Meal<VegetarianMeal>(vegetarianMeal);
        ...
        List<MealPlan> meals = new ArrayList<MealPlan>();
    ...
    void testDisplayAllMeals() {
        ...
        List<MealPlan> allMeals = new ArrayList<MealPlan>();
